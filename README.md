...
This repository showcases my expertise in building scalable **Data Engineering pipelines**, implementing **Machine Learning** retrieval systems, and performing **Advanced Data Analytics**. My work spans from architecting automated ETL workflows at UCSD and UB to developing full-stack tracking systems and AI-driven recommendation engines.

---

## 🚀 Featured Projects

### 1. UCSD Wireless Data Ingestion Framework (`/wireless`)
...
### 2. RAG Retrieval System (`/buffalo_housing_dashboard`)
...
### 3. CTS Bus Tracking System (`/CTS bus tracking/new final project`)
...
### 4. Eye-Controlled Wheelchair (`/eye-controlled wheelcha`)
...
### 5. Professional Banking System (`/banking system`)
...
**Data Engineering:** ETL/ELT Pipelines, Azure Pipelines, Apache Spark, Data Modeling.

**Databases & Vector Stores:** MySQL, SQLite, ChromaDB.

**Tools:** Docker, REST APIs, Git/GitHub, Pandas, NumPy.

## 🎓 Education
* **M.S. in Data Science** | University of Texas at Arlington 
* **BTech in ECE** | Andhra University 

---

## 📬 Contact
* **Email:** pratyushaadibhatla3@gmail.com 
* **LinkedIn:** [linkedin.com/in/pratyushaadibhatla](https://www.linkedin.com/in/pratyushaadibhatla) 
